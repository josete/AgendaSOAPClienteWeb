...
public class VerAgenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        agendasoap.Agenda a = service.getValidarPort().devolverAgenda();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            for (agendasoap.Persona p : a.getPersona()) {
                out.println("<h3>Nombre: " + p.getName() + "</h3>");
                out.println("<h3>Telefono: " + p.getTelephone() + "</h3>");
