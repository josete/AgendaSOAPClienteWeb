...
public class MainServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form action='/ClienteSoapWeb/GuardarPersona' method='POST'>");
            ...
            out.println("</form>");
            out.println("<hr>");
            out.println("<form action='/ClienteSoapWeb/VerPersona' method='POST'>");
                out.println("<input type='text' name='nombre'>");
                out.println("<input type='submit' value='Ver persona'>");
            out.println("</form>");
            out.println("<hr>");
            out.println("<form action='/ClienteSoapWeb/VerAgenda' method='POST'>");
